...
type Querier interface {
	...
	GetLatestWeekRecapForLeague(ctx context.Context, leagueID pgtype.UUID) (WeekRecap, error)
	...
	ListWeekRecapFactsForLeague(ctx context.Context, arg ListWeekRecapFactsForLeagueParams) ([]ListWeekRecapFactsForLeagueRow, error)
	...
	// codebase.
	UpsertWeekRecap(ctx context.Context, arg UpsertWeekRecapParams) (WeekRecap, error)
}
